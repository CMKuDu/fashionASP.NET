...
namespace DTN4.Areas.Admin.Controllers
{
    ...
    public class adminRolesController : Controller
    {
        ...
        public adminRolesController(DTNContext context, INotyfService notifyService)
        {
            _context = context;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DTNContext.Roles'  is null.");
            }
            var role = await _context.Roles.FindAsync(id);
            if (role != null)
            {
            ...
            await _context.SaveChangesAsync();
            _notifyService.Success("Xoá quyền truy cập thành công");
            return RedirectToAction(nameof(Index));
        }
